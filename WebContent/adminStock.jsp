...
<body style="background-color: #E6F9E6;">
	...
	<div class="text-center"
		style="color: green; font-size: 24px; font-weight: bold;">Best-Selling Items</div>
		...
		<div class="table-responsive ">
			<table class="table table-hover table-sm">
				...
				<tbody style="background-color: white; font-size: 16px;">
					...
					<%
					ProductServiceImpl bsProductDao = new ProductServiceImpl();
					List<ProductBean> bsProducts = new ArrayList<ProductBean>();
					bsProducts = bsProductDao.getBestSellingProducts();
					for (ProductBean product : bsProducts) {
					%>
	...
	<div class="text-center"
		style="color: green; font-size: 24px; font-weight: bold;">Least-Selling Items</div>
	<div class="container-fluid">
		<div class="table-responsive ">
			<table class="table table-hover table-sm">
				<thead
				...
				<tbody style="background-color: white; font-size: 16px;">
					...
					<%
					ProductServiceImpl lsProductDao = new ProductServiceImpl();
					List<ProductBean> lsProducts = new ArrayList<ProductBean>();
					lsProducts = lsProductDao.getLeastSellingProducts();
					for (ProductBean product : lsProducts) {
					%>
